...
/**
 * About section converted from Svelte to React. It introduces the
 * author, summarizing experience and passion for web development,
 * alongside a profile image. The layout mirrors the original
 * two‑column design with responsive ordering: text appears below
 * the image on small screens and to the left on larger screens.
 */
const About = () => {
