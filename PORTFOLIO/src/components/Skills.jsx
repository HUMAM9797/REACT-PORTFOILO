...
/**
 * Skills section converted from Svelte to React. It organizes
 * programming languages, databases, tools, and frameworks into
 * categories and displays them in a responsive grid. A decorative
 * image is positioned absolutely behind the grid as in the original
 * Svelte code. Adjust image paths according to your project setup.
 */
const Skills = () => {
    // Define the skill categories and associated skills
