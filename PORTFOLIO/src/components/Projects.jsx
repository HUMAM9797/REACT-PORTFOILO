...
/**
 * Projects section converted from Svelte to React. It defines a list
 * of sample projects and renders them in a responsive grid layout
 * similar to the original Svelte implementation. Each project card
 * displays an image, a technology tag strip, a title, a description,
 * and a call‑to‑action link. Animations from the Svelte version
 * (flip, fade, fly, slide) are not included; however, the CSS
 * classes remain, allowing you to add custom transitions or
 * integrate an animation library if desired.
 */
const Projects = () => {
    // Define the projects data. Image paths reference files in the
    // public/images directory. Adjust the paths based on your build setup.
    const projects = [
        {
            id: 1,
            title: "ChertNodes",
